    ...
    <>
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="flex flex-col items-start gap-1 rounded-[1.5rem] border border-white/10 bg-white/[0.04] px-4 py-3 text-left backdrop-blur-xl transition hover:bg-white/[0.07]"
        >
