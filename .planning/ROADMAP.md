...
- [ ] 05-01-PLAN.md — STEPS `route?` field (D-06/D-07) + `CoachmarkCard` inline `surface` slot (D-01/D-02/D-03)
- [ ] 05-02-PLAN.md — cross-route `data-tour` anchors on /groups, /notifications, /shortcut + `data-pending-count` (TOUR-05/ONB-03/TEACH-02..04)
...
| 5. Cross-Route Walkthrough & Teaching Content | v1.1 | 0/4 | Not started | - |
