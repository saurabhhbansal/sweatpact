...
- [x] 09-01-PLAN.md — Owner gate: parseAdminUserIds + requireOwner (404, fail-closed) with tests (ADMIN-01)
- [x] 09-02-PLAN.md — Supabase metrics helpers: settlement rate, active-pact, ISO-week trend buckets, geo-fail merge (DASH-01/02/03)
- [x] 09-03-PLAN.md — PostHog Query API client + static HogQL builders + Zod parsers + env docs (DASH-04/05/06)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 09-04-PLAN.md — Supabase panel components + recharts: financial, user, range control, trend chart (DASH-01/02/03)
- [x] 09-05-PLAN.md — PostHog panel components: onboarding funnel, feature adoption, engagement/retention (DASH-04/05/06)
